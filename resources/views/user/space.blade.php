...
<div class="hero-section" 
    ...
    <p>
        <a href="{{ route('user.clothes') }}" class="btn btn-sm animated-button1">Voir plus de vêtements</a>
    </p>
</div>
                        ...
                        <img src="{{ asset('storage/' . $article->hover_image) }}" 
                             ...
                             <div class="quick-view bg-black">
                                <a href="#" 
                                   ...
                                   data-image="{{ asset('storage/' . $article->main_image) }}">
                                   Commander
                                </a>
                            </div>
                    </div>
                    <div class="product-details">
                        <h3 class="product-name" style="margin-bottom: 10px">{{ $article->name }}</h3>
...
<div class="container1">
    <div class="text-section">
        ...
        <a href="{{ route('user.shoes') }}">Voir plus de chaussures</a>
    </div>
                ...
                <div class="product-item">
                    <div class="image-container">
                        ...
                        <img src="{{ asset('storage/' . $accessoire->hover_image) }}" 
                             ...
                             class="hover-image">
                        <div class="quick-view bg-black"><a href="" style="color: white">Commander</a></div>
                    </div>
                    <div class="product-details">

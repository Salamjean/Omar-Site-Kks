<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="{{ route('vendor.dashboard') }}" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Omar</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item active">
        <a href="{{ route('fournisseur.dashboard') }}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Authentications">Vêtements</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('fournisseur.vetements') }}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon fa-solid fa-shoe-prints"></i>
          <div data-i18n="Account Settings">Chaussures</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('fournisseur.chaussures') }}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Account Settings">Accessoires</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('fournisseur.accessoires') }}" class="menu-link">

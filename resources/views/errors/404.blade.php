<header class="site-navbar" role="banner">
  ...
  <div class="col-4 col-lg-4 order-1 order-lg-1 text-left d-none d-lg-block">
    <form action="#" method="GET" class="site-block-top-search" id="search-form-desktop">
    ...
    <hr class="search-hr">
          ...
          <div class="col-4 col-md-4 order-2 order-md-2 text-center">
            <div>
              <a href="#" class="js-logo-clone"><img src="{{ asset('assets/images/omarnoir.png') }}" style="width: 300px; height:30px" alt=""></a>
            </div>
          </div>
              ...
              <ul>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="#"><i class="fa-solid fa-right-to-bracket"></i> Connexion</a></li>
                  </ul>
                </li>
